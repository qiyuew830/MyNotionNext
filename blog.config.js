...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.qiyueblog.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '75b34194f2b64278b1b4d856947ce157',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Qiyue', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '做难而正确的事', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qiyuetch.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 工程, 设计', // 网站关键词 英文逗号隔开
