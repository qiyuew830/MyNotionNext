...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '聊数码, 聊摄影, 聊设计,🎉欢迎来到我的网站🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'QiyueW', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '设计与工程，科技和人文', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'qiyuetech.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'tech, photography, programming', // 网站关键词 英文逗号隔开
